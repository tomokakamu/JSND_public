...
class Ai1wmke_Reset_Plugins {
	...
	public static function execute( $params ) {
		...
		foreach ( array_keys( get_plugins() ) as $plugin ) {
			if ( stripos( $plugin, AI1WM_PLUGIN_NAME ) !== false ) {
				continue;
			}
		...
		if ( $completed ) {
			...
			if ( ! isset( $params['ai1wm_reset_plugins'], $params['ai1wm_reset_themes'], $params['ai1wm_reset_media'], $params['ai1wm_reset_database'] ) ) {
				$message = __( 'All installed plugins have been successfully removed from your site. This action has cleared any settings, data, and customizations associated with those plugins. Your site is now in a clean state, free of any plugins. You can begin reinstalling your preferred plugins to configure your site with the functionality you need.', AI1WMKE_PLUGIN_NAME );
				if ( defined( 'WP_CLI' ) ) {
