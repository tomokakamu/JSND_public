	...
	public static function execute( $params ) {
		...
		if ( $completed ) {
			...
			if ( ! isset( $params['ai1wm_reset_plugins'], $params['ai1wm_reset_themes'], $params['ai1wm_reset_media'], $params['ai1wm_reset_database'] ) ) {
				$message = __( 'The reset of your media files has been successfully completed. Your site\'s media library is now empty, and you can start afresh with new uploads.', AI1WMKE_PLUGIN_NAME );
				if ( defined( 'WP_CLI' ) ) {
