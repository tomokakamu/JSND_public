...
class Ai1wmke_OneDrive_Export_Retention extends Ai1wmke_Export_Retention_Base {

	/**
	 * OneDrive client
	 *
	 * @var Ai1wmke_OneDrive_Client
	 */
	...
	protected function get_files() {
		$items = $this->onedrive->list_folder( $this->folder_id );
	...
	protected function delete_file( $backup ) {
		return $this->onedrive->delete( $backup['id'] );
	}

	protected function setup_client( $client ) {
		// Set OneDrive client
		if ( is_null( $client ) ) {
			$client = new Ai1wmke_OneDrive_Client(
