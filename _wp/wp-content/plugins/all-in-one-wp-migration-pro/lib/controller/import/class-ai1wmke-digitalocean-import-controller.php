...
class Ai1wmke_DigitalOcean_Import_Controller {

	public static function button() {
		return Ai1wm_Template::get_content(
			'import/button/button-digitalocean',
			array( 'access_key' => get_option( 'ai1wmke_digitalocean_access_key', ai1wmke_aws_access_key() ) ),
	...
	public static function picker() {
		Ai1wm_Template::render(
			'import/picker/picker-digitalocean',
			array(),
			AI1WMKE_TEMPLATES_PATH
		);
	}
	...
	public static function incremental( $params = array() ) {
		...
		try {
			$file_content = $digitalocean->get_file_content( sprintf( '/%s/incremental.backups.list', $folder_path ), $bucket_name, $region_name );
