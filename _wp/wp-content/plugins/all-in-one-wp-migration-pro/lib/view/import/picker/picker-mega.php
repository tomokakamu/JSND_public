...
<div id="ai1wmke-mega-import-modal" class="ai1wmke-mega-modal-container" role="dialog" tabindex="-1">
	<div class="ai1wmke-mega-modal-content" v-if="items !== false">
		<div class="ai1wmke-mega-file-browser">
			...
			<ul class="ai1wmke-mega-file-list">
				...
				<li class="ai1wmke-mega-file-info" v-if="num_hidden_files === 1">
					{{ num_hidden_files }}
	...
	<div class="ai1wmke-mega-modal-action">
		<transition>
			<p class="ai1wmke-mega-selected-file" v-if="file">
...
<div id="ai1wmke-mega-import-overlay" class="ai1wmke-mega-overlay"></div>
