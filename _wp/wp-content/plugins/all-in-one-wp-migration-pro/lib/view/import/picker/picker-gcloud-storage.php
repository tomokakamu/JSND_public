...
<div id="ai1wmke-gcloud-storage-import-modal" class="ai1wmke-gcloud-storage-modal-container" role="dialog" tabindex="-1">
		...
		<div class="ai1wmke-gcloud-storage-file-browser">
			<div class="ai1wmke-gcloud-storage-path-list">
				<template v-for="(item, index) in path">
					...
					<span v-else>
						<span class="ai1wmke-gcloud-storage-path-item" v-html="item.name"></span>
					</span>
				</template>
			</div>
			...
			<ul class="ai1wmke-gcloud-storage-file-list">
				<li class="ai1wmke-gcloud-storage-file-title" v-if="items.length > 0">
					...
					<span class="ai1wmke-gcloud-storage-file-size">
						<?php _e( 'Size', AI1WMKE_PLUGIN_NAME ); ?>
					</span>
				</li>
				<li class="ai1wmke-gcloud-storage-file-item" v-for="item in items" v-on:click="browse(item)">
					<span class="ai1wmke-gcloud-storage-file-name">
						<i v-bind:class="icon(item)"></i>
						{{ item.name }}
					</span>
					<span class="ai1wmke-gcloud-storage-file-date">{{ item.date }}</span>
					<span class="ai1wmke-gcloud-storage-file-size">{{ item.size }}</span>
				</li>
				<li
				...
				<li class="ai1wmke-gcloud-storage-file-info" v-if="num_hidden_files === 1">
					{{ num_hidden_files }}
	...
	<div class="ai1wmke-gcloud-storage-modal-action">
		<transition>
			<p class="ai1wmke-gcloud-storage-selected-file" v-if="file">
...
<div id="ai1wmke-gcloud-storage-import-overlay" class="ai1wmke-gcloud-storage-overlay"></div>
