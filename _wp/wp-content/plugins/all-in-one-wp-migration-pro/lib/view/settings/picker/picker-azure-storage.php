...
<div id="ai1wmke-azure-storage-settings-modal" class="ai1wmke-azure-storage-modal-container">
		...
		<div class="ai1wmke-azure-storage-file-browser">
			<div class="ai1wmke-azure-storage-path-list">
				<template v-for="(item, index) in path">
					...
					<span v-else>
						<span class="ai1wmke-azure-storage-path-item" style="cursor: default" v-html="item.label"></span>
					</span>
				</template>
			</div>

			<ul class="ai1wmke-azure-storage-file-list">
				<li class="ai1wmke-azure-storage-file-title" v-if="items !== false && items.length > 0">
				...
				<li
					...
					v-bind:class="{'ai1wmke-azure-storage-dir-selected': (item === selectedItem || isPreselectedItem(item))}"
	...
	<div class="ai1wmke-azure-storage-modal-legend">
		<p style="box-shadow: 0px -1px 1px 0px rgb(221, 221, 221);" class="ai1wmke-azure-storage-file-info" v-if="items !== false">
	...
	<div class="ai1wmke-azure-storage-modal-action">
		<p class="ai1wmke-azure-storage-justified-container">
...
<div id="ai1wmke-azure-storage-settings-overlay" class="ai1wmke-azure-storage-overlay"></div>
