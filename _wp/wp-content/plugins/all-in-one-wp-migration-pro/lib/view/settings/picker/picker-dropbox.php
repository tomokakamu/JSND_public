...
<div id="ai1wmke-dropbox-settings-modal" class="ai1wmke-dropbox-modal-container">
		...
		<div class="ai1wmke-dropbox-file-browser">
			...
			<div class="ai1wmke-dropbox-file-list" v-if="items !== false && items.length > 0">
				<div class="ai1wmke-dropbox-file-item">
					<span style="width: 75%;" class="ai1wmke-dropbox-file-name-header">
			...
			<ul class="ai1wmke-dropbox-file-list">
				<li
					...
					v-bind:class="{'ai1wmke-dropbox-dir-selected': (item === selectedItem || isPreselectedItem(item))}"
					class="ai1wmke-dropbox-file-item">
					<span style="width: 75%;" class="ai1wmke-dropbox-file-name">
...
<div id="ai1wmke-dropbox-settings-overlay" class="ai1wmke-dropbox-overlay"></div>
