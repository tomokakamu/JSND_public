...
<div id="ai1wmke-pcloud-settings-modal" class="ai1wmke-pcloud-modal-container">
		...
		<div class="ai1wmke-pcloud-file-browser">
			<div class="ai1wmke-pcloud-path-list">
				<template v-for="(item, index) in path">
					...
					<span v-else>
						<span class="ai1wmke-pcloud-path-item" style="cursor: default" v-html="item.name"></span>
					</span>
				</template>
			</div>
			<div class="ai1wmke-pcloud-file-list" v-if="items !== false && items.length > 0">
				<div class="ai1wmke-pcloud-file-item">
					<span style="width: 75%;" class="ai1wmke-pcloud-file-label">
			...
			<ul class="ai1wmke-pcloud-file-list">
				<li
					...
					v-bind:class="{'ai1wmke-pcloud-dir-selected': (item === selectedItem || isPreselectedItem(item))}"
					class="ai1wmke-pcloud-file-item">
					<span style="width: 75%;" class="ai1wmke-pcloud-file-label">
	...
	<div class="ai1wmke-pcloud-modal-loader" v-if="items === false">
		...
		<p>
			<span class="ai1wmke-pcloud-contact-pcloud">
				<?php _e( 'Connecting to pCloud ...', AI1WMKE_PLUGIN_NAME ); ?>
			</span>
		</p>
	</div>

	<div class="ai1wmke-pcloud-modal-legend">
		<p style="box-shadow: 0px -1px 1px 0px rgb(221, 221, 221);" class="ai1wmke-pcloud-file-info" v-if="items !== false">
	...
	<div class="ai1wmke-pcloud-modal-action">
		<p class="ai1wmke-pcloud-justified-container">
...
<div id="ai1wmke-pcloud-settings-overlay" class="ai1wmke-pcloud-overlay"></div>
