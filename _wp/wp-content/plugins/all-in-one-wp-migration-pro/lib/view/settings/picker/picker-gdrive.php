...
<div id="ai1wmke-gdrive-settings-modal" class="ai1wmke-gdrive-modal-container">
		...
		<div class="ai1wmke-gdrive-file-browser">
			...
			<div class="ai1wmke-gdrive-file-list" v-if="items.length > 0">
				<div class="ai1wmke-gdrive-file-item">
					<span style="width: 75%;" class="ai1wmke-gdrive-file-name-header">
			...
			<ul class="ai1wmke-gdrive-file-list">
				<li v-for="item in items" v-on:click="select(item)" v-on:dblclick="browse(item)" v-bind:class="{'ai1wmke-gdrive-dir-selected': (item === selectedItem || isPreselectedItem(item))}" class="ai1wmke-gdrive-file-item">
					<span style="width: 75%;" class="ai1wmke-gdrive-file-name">
...
<div id="ai1wmke-gdrive-settings-overlay" class="ai1wmke-gdrive-overlay"></div>
